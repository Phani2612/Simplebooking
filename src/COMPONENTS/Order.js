...
<button id='yourbook' type="button" class="btn btn-light"><h1>Your Bookings</h1></button>
...
<div className='ticket-container'>
   ...
   <Link to='/home' > <button id='OrderHome' type="button" class="btn btn-light">Please go back to Home page</button></Link>
